...
## Features
   ...
   - Transfer ADS contents to remote lisetner
   - Demonstrates ADS abuse techniques in Windows environments
...
Defenders can monitor for:
   - Suspicious ADS access activity
   - PowerShell network connections
   - Unusual outbound TCP connections
   - Hidden stream enumeration activity
